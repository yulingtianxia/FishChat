...
@class EditImageAttr, EditImageIntialView, MMCircularProgressView, MMLoadingView, MMSightRecordView, NSMutableArray, NSString, ShortVideoToolbarPreviewView, SightCameraTopToolView, UIButton, UIImage, UIImageView, UILabel, UIView, UIView<SightPreviewView>;
